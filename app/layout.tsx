...
const APP_URL =
  process.env.NEXT_PUBLIC_APP_URL ?? "https://btechcareerhub.com";
...
const organizationJsonLd = {
  ...
  url: APP_URL,
  description:
    "A career-prep platform for Indian B.Tech students covering GATE, PSU recruitment, CAT and placements.",
};
